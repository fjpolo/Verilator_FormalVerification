////////////////////////////////////////////////////////////////////////////////
//
// Filename: 	onehzblinky.cpp
//
// Project:	Verilog Tutorial Example file
//
// Purpose:	Main Verilator simulation script for the onehzblinky design
//
...
void tick(int tick_count, Vonehzblinky *tb, VerilatedVcdC* tfp){
...
int main(int argc, char **argv) {
    ...
    // Instantiate design
    Vonehzblinky *tb = new Vonehzblinky;

    // Generate a trace
    Verilated::traceEverOn(true);
    VerilatedVcdC* tfp = new VerilatedVcdC;
    tb->trace(tfp, 99);
    tfp ->open("onehzblinkytrace.vcd ");
