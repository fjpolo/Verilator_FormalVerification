...
`ifdef	FORMAL
	...
	generate if (F_TESTID == 1) begin : F_TESTID_ONE	// Fails
	...
	end else if (F_TESTID == 2)	begin : F_TESTID_TWO	// Succeeds
		//
		// Test #2
		//
		always @(*)
		...
		always @(posedge i_clk)
			assert(counter == 0);
	end else if (F_TESTID == 3) begin : F_TESTID_THREE	// Fails
		// //
		// // Test #3
		// //
		// always @(posedge i_clk)
	...
	end else if (F_TESTID == 4) begin : F_TESTID_FOUR
		//
		// Test #4
		//
		reg	f_past_valid;
