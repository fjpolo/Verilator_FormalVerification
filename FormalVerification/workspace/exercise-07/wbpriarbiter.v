...
module	wbpriarbiter #(
		...
		// to drive wires all the way across the design, but it may
		// also slow down the master clock.  I've used it as an option
		// when using VERILATOR, 'cause zeroing things on idle can
